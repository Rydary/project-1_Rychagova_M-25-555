...
ROOMS = {
    ...
    'library': {
          ...
          'items': ['ancient book'],
          'puzzle': ('В одном свитке загадка: "Какой болезнью не болеют на суше?" ', 'морской')
    },
        'armory': {
    ...
    'basement': {
        ...
        'items': ['sack'],
        'puzzle': ('Ответьте на загадку: утром на четырех ногах, днем - на двух, вечером - на трех', 'человек')
    },
    'fireplace_room': {
        'description': 'Небольшая уютная комната, стены которой покрыты коврами, и пылает камин.',
